...
readConfig() {
	...
	SS_SET_BACKLIGHT=$($BBX fgrep "SS_SET_BACKLIGHT=" $SS_CONFIG | $BBX sed 's/SS_SET_BACKLIGHT=//')
	SS_SET_FRAMEBUFFER=$($BBX fgrep "SS_SET_FRAMEBUFFER=" $SS_CONFIG | $BBX sed 's/SS_SET_FRAMEBUFFER=//')
...
dumpConfig() {
	...
	$BBX echo "<1>SS_SET_BACKLIGHT=$SS_SET_BACKLIGHT" > /dev/kmsg
	$BBX echo "<1>SS_SET_FRAMEBUFFER=$SS_SET_FRAMEBUFFER" > /dev/kmsg
